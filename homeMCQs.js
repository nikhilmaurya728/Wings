...
var data = {
  ...
  "🧠 General Knowledge": {
    "🟢 Basic": '<h2>General Knowledge Basic Level </h2><div class="cards"><button class= "auto-click-btn" onclick="startcreateCard(this, cardsData, \'.cards\')">Show Cards</button></div>',

    "🟡 Medium": '<div class="cards1">fddddddddd<button class= "auto-click-btn" onclick="startcreateCard(this, cardsData, \'.cards1\')">Show Cards</button></div>',

    "🔴 Advanced": '<div class="cards2">fddddddddd<button class= "auto-click-btn" onclick="startcreateCard(this, cardsData, \'.cards2\')">Show Cards</button></div>',
